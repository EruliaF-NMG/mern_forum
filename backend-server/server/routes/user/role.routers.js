 ...
 * @Last Modified time: 2021-03-13 23:21:51
 */
...
router
  .route('/roles')
  .get(isAuth, isRole(roleCodes.admin), roleController.getAll);
...
router
  .route('/roles/:roleID')
  .get(isAuth, isRole(roleCodes.admin), roleController.getCurrentRole);
